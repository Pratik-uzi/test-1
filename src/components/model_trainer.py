...
class ModelTrainer:
    ...
    "K-Neighbors Regressor":{ # Added missing parameters
        'n_neighbors': [3, 5, 7, 9],
        'weights': ['uniform', 'distance']
            ...
            if best_model_score<0.6:
                raise CustomException("Model performance is not satisfactory, please try with different model")
    ...
    test_array=test_arr,
    preprocessor_path="test-1/artifacts/preprocessor.pkl"
)
    '''